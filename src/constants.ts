...
export const TAPPLE_ROUNDS: TappleRound[] = [
  ...
  { id: 6, category: 'File Operations', examples: ['open', 'close', 'read', 'write', 'append', 'ifstream', 'ofstream'] },
  { id: 7, category: 'Errors/Bugs', examples: ['Syntax', 'Runtime', 'Logical', 'Segmentation Fault', 'Memory Leak'] },
  { id: 8, category: 'Functions Terminology', examples: ['Parameter', 'Argument', 'Return Type', 'Prototype', 'Definition', 'Call'] },
  { id: 9, category: 'Array Operations', examples: ['Initialization', 'Traversal', 'Insertion', 'Deletion', 'Access'] },
  { id: 10, category: 'Algorithm Vocabulary', examples: ['Complexity', 'Efficiency', 'Pseudocode', 'Flowchart', 'Iteration'] }
];
